...
import { CheckCircle2, Clock, Download, Edit2, FolderOpen, Info, Layers, Loader2, Mail, Plus, Save, Search, Settings, Shield, Trash2, X, XCircle } from "lucide-react";
...
/** Test a connection using the shared backend tester (works pre-add). */
        ...
        <div className="border-t border-border pt-4 space-y-3">
          ...
          {form.infoPopupMode !== "disabled" && (
            <textarea
              ...
              placeholder="Disclaimer text — emojis are supported ⚠️ 📢"
...
/**
 * Add-form footer that forces a successful connection test before the item can
 * be saved.
 */
